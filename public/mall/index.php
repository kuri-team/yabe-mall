...
?>
    ...
    <main id="mall-main">
        ...
        <section class="mall-home-section" id="featured-products">
            <h1>FEATURED PRODUCTS<span class="mall-home-section-heading-link"><a href="<?=url_for("/404/404.php");?>">ALL</a></span></h1>
        ...
        <section class="mall-home-section" id="featured-stores">
            <h1>FEATURED STORES<span class="mall-home-section-heading-link"><a href="<?=url_for("/404/404.php");?>">ALL</a></span></h1>
        ...
        <section class="mall-home-section card-gallery">
            <h1 class="card-gallery-title">NEW STORES<span class="mall-home-section-heading-link"><a href="<?=url_for("/404/404.php");?>">MORE</a></span></h1>
