...
<main id="content">
  <ul class=breadcrumb>
    ...
    <li><a href="<?=url_for("/404/404.php");?>">Browse Products</a>/</li>
  ...
  <div class="content-body">
    ...
    <div class="product-list">
      <div class="flex-container flex-justify-content-space-evenly flex-wrap">
        ...
        <div class="product-card">
          <a href="<?=url_for("/store/store-template/product-detail");?>"><img alt="image of a product" src="../../../media/image/sephora_shop/sunscreen/15_sephora.jpg"></a>
          <div class="product-card-details">
            <a class="product-card-title" href="<?=url_for("/store/store-template/product-detail");?>">Product Title Goes Here</a>
            <a class="product-card-shop" href="<?=url_for("/store/store-template");?>">Shop Name Goes Here</a>
            <p class="product-card-price-crossed-out">$22.99</p>
        ...
        <div class="product-card">
          <a href="<?=url_for("/store/store-template/product-detail");?>"><img alt="image of a product" src="../../../media/image/zappos_shop/boots/4_zappos.jpg"></a>
          <div class="product-card-details">
            <a class="product-card-title" href="<?=url_for("/store/store-template/product-detail");?>">Product Title Goes Here</a>
            <a class="product-card-shop" href="<?=url_for("/store/store-template");?>">Shop Name Goes Here</a>
            <p class="product-card-price-crossed-out">$22.99</p>
        ...
        <div class="product-card">
          <a href="<?=url_for("/store/store-template/product-detail");?>"><img alt="image of a product" src="../../../media/image/best_buy_shop/watches/11_best_buy.jpg"></a>
          <div class="product-card-details">
            <a class="product-card-title" href="<?=url_for("/store/store-template/product-detail");?>">Product Title Goes Here</a>
            <a class="product-card-shop" href="<?=url_for("/store/store-template");?>">Shop Name Goes Here</a>
            <p class="product-card-price-crossed-out">$22.99</p>
        ...
        <div class="product-card">
          <a href="<?=url_for("/store/store-template/product-detail");?>"><img alt="image of a product" src="../../../media/image/sephora_shop/body/9_sephora.jpg"></a>
          <div class="product-card-details">
            <a class="product-card-title" href="<?=url_for("/store/store-template/product-detail");?>">Product Title Goes Here</a>
            <a class="product-card-shop" href="<?=url_for("/store/store-template");?>">Shop Name Goes Here</a>
            <p class="product-card-price-crossed-out">$22.99</p>
        ...
        <div class="product-card">
          <a href="<?=url_for("/store/store-template/product-detail");?>"><img alt="image of a product" src="../../../media/image/sephora_shop/body/8_sephora.jpg"></a>
          <div class="product-card-details">
            <a class="product-card-title" href="<?=url_for("/store/store-template/product-detail");?>">Product Title Goes Here</a>
            <a class="product-card-shop" href="<?=url_for("/store/store-template");?>">Shop Name Goes Here</a>
            <p class="product-card-price-crossed-out">$22.99</p>
        ...
        <div class="product-card">
          <a href="<?=url_for("/store/store-template/product-detail");?>"><img alt="image of a product" src="../../../media/image/best_buy_shop/others/16_best_buy.jpg"></a>
          <div class="product-card-details">
            <a class="product-card-title" href="<?=url_for("/store/store-template/product-detail");?>">Product Title Goes Here</a>
            <a class="product-card-shop" href="<?=url_for("/store/store-template");?>">Shop Name Goes Here</a>
            <p class="product-card-price-crossed-out">$22.99</p>
        ...
        <div class="product-card">
          <a href="<?=url_for("/store/store-template/product-detail");?>"><img alt="image of a product" src="../../../media/image/zappos_shop/boots/3_zappos.jpg"></a>
          <div class="product-card-details">
            <a class="product-card-title" href="<?=url_for("/store/store-template/product-detail");?>">Product Title Goes Here</a>
            <a class="product-card-shop" href="<?=url_for("/store/store-template");?>">Shop Name Goes Here</a>
            <p class="product-card-price-crossed-out">$22.99</p>
